...
exports.GetNewSupportMessageEmailTemplate = exports.GetNewCarPendingApprovalNotificationEmailTemplate = exports.GetDailyEmailTemplate = exports.GetQuestionAnsweredNotificationEmailTemplate = exports.GetRepliedCommentNotificationEmailTemplate = exports.GetNewCommentNotificationEmailTemplate = exports.GetNewAuctionNotificationEmailTemplate = exports.GetAuctionEndedSoonNotificationEmailTemplate = exports.GetAuctionEdningSoonNotificationEmailTemplate = exports.GetNewBidNotificationEmailTemplate = exports.GetUserResetingPasswordEmailTemplate = exports.GetUserVerificationEmailTemplate = void 0;
const moment_1 = __importDefault(require("moment"));
const convertNumberToCurrency_1 = __importDefault(require("../utils/convertNumberToCurrency"));
function GetUserVerificationEmailTemplate(href, username) {
    return `
...
exports.GetUserVerificationEmailTemplate = GetUserVerificationEmailTemplate;
function GetUserResetingPasswordEmailTemplate(href, username) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetUserResetingPasswordEmailTemplate = GetUserResetingPasswordEmailTemplate;
function GetNewBidNotificationEmailTemplate({ title, bidderUsername, bid, imgUrl, carUrl }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
                        ...
                        <td>
                            ...
                            <tbody>
                                ...
                                <td
                                    ...
                                    >
                                    A new <span class="il">bid</span> for ${convertNumberToCurrency_1.default(bid)} was placed by ${bidderUsername}.
                                </td>
                                </tr>
                            </tbody>
                            </table>
...
exports.GetNewBidNotificationEmailTemplate = GetNewBidNotificationEmailTemplate;
function GetAuctionEdningSoonNotificationEmailTemplate({ title, endDate, imgUrl, carUrl }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetAuctionEdningSoonNotificationEmailTemplate = GetAuctionEdningSoonNotificationEmailTemplate;
function GetAuctionEndedSoonNotificationEmailTemplate({ title, imgUrl, carUrl, soldText }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetAuctionEndedSoonNotificationEmailTemplate = GetAuctionEndedSoonNotificationEmailTemplate;
function GetNewAuctionNotificationEmailTemplate({ title, imgUrl, carUrl, }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetNewAuctionNotificationEmailTemplate = GetNewAuctionNotificationEmailTemplate;
function GetNewCommentNotificationEmailTemplate({ title, imgUrl, carUrl, username, text }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetNewCommentNotificationEmailTemplate = GetNewCommentNotificationEmailTemplate;
function GetRepliedCommentNotificationEmailTemplate({ title, imgUrl, carUrl, username, text }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetRepliedCommentNotificationEmailTemplate = GetRepliedCommentNotificationEmailTemplate;
function GetQuestionAnsweredNotificationEmailTemplate({ title, imgUrl, carUrl, usernameAnswer, usernameQuestion, answer, question }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetQuestionAnsweredNotificationEmailTemplate = GetQuestionAnsweredNotificationEmailTemplate;
function GetDailyEmailTemplate({ newCars, endedCars, homepageUrl }) {
    return `
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <tbody>
                                <tr>
                                <td align="left" style="font-size: 22px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-weight: 600; color: #202124;" class="m_9199855055071283069padding">
                                    Auctions Closing Today — ${moment_1.default().format('MMMM Do')}.
                                    <br/>
                                    <br/>
                                </td>
                                </tr>
...
exports.GetDailyEmailTemplate = GetDailyEmailTemplate;
function GetNewCarPendingApprovalNotificationEmailTemplate({ title, imgUrl, carUrl, }) {
    return `
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
...
exports.GetNewCarPendingApprovalNotificationEmailTemplate = GetNewCarPendingApprovalNotificationEmailTemplate;
function GetNewSupportMessageEmailTemplate(message, href) {
    return `
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
...
exports.GetNewSupportMessageEmailTemplate = GetNewSupportMessageEmailTemplate;
//# sourceMappingURL=GetEmailTemlate.js.map